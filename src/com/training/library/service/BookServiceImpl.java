...
public class BookServiceImpl implements BookService {
    ...
    public BookServiceImpl() {
        ...
        books.put("0004", new Book("0004", "Spring Enterprise ", "Steve", new GregorianCalendar(2010, 6, 1).getTime()));
        books.put("0005", new Book("0005", "Spring Web ", "Rod", new GregorianCalendar(2010, 6, 1).getTime()));
    }
